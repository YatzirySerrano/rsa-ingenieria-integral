...
const email = 'contacto@rsaingenieria.com'
</script>
      ...
      <div class="grid gap-10 lg:grid-cols-12">
        ...
        <div class="lg:col-span-4">
          ...
          <div class="mt-6 flex items-center gap-3">
            <a :href="facebook" target="_blank" aria-label="Facebook" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" class="h-5 w-5 fill-white/80 transition hover:fill-white">
                <path
            ...
            <a :href="tiktok" target="_blank" aria-label="TikTok" rel="noopener noreferrer">
              <svg viewBox="0 0 24 24" class="h-5 w-5 fill-white/80 transition hover:fill-white">
                <path
        ...
        <div class="lg:col-span-3">
          ...
          <div class="mt-3 flex flex-col gap-2">
            <button
              ...
              :key="l.id"
              type="button"
              class="w-fit text-sm text-white/75 transition hover:text-white"
        ...
        <div class="lg:col-span-5">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            class="mt-3 block overflow-hidden rounded-2xl"
          >
            <iframe
              :src="mapsEmbed"
              width="100%"
