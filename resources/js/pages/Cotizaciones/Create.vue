<script setup lang="ts">
    ...
    const { isConfirmed } = await swalConfirm('Se creará la cotización en el sistema (BD).', {
        title: 'Confirmar',
        confirmText: 'Crear',
    })
...
<template>
    <AppLayout>
        <Head title="Crear cotización | Panel" />
        ...
        <div class="flex items-end justify-between gap-3">
            ...
            <h1 class="text-2xl sm:text-3xl font-black tracking-tight text-slate-900 dark:text-zinc-100">
                Crear cotización (Panel)
            </h1>
            <p class="text-sm text-slate-600 dark:text-zinc-400">
                Admin/Vendedor crea una cotización en BD. Luego puedes abrirla y enviarla por correo desde el sistema.
            </p>
            </div>
        ...
        <div class="mt-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="rounded-2xl border border-black/5 bg-white shadow-sm p-4 dark:bg-zinc-900/60 dark:border-white/10">
                ...
                >
                    ...
                    <Button class="mt-3 w-full font-extrabold" @click="addProducto(p.id)">Agregar</Button>
                </div>
                ...
                >
                    ...
                    <Button class="mt-3 w-full font-extrabold" @click="addServicio(s.id)">Agregar</Button>
                </div>
                </div>
            </div>
            </div>
            ...
            <div class="rounded-2xl border border-black/5 bg-white shadow-sm p-4 dark:bg-zinc-900/60 dark:border-white/10">
                ...
                <p class="text-xs text-slate-600 dark:text-zinc-400">
                    Captura al menos correo o teléfono.
                </p>
                </div>
            </div>
            </div>
