                ...
                <div class="flex flex-col gap-4">
                    <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <Button class="gap-2 font-extrabold">Nueva</Button>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 gap-2 md:grid-cols-12 md:items-end">
                        ...
                        <label class="mb-1 text-xs font-extrabold text-slate-700 dark:text-zinc-300">Estatus</label>
                        <select
                ...
                <div class="overflow-x-auto">
                    ...
                    <tbody>
                        ...
                        <td class="px-5 py-4">
                            ...
                            <p class="mt-1 text-xs text-slate-500 dark:text-zinc-500">Backend: {{ c.estatus }}</p>
                        </td>
