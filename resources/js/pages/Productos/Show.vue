...
function firstImage(p: Producto) {
  ...
  const main = medias.find((m) => m.principal) ?? medias.slice().sort((a, b) => (a.orden ?? 0) - (b.orden ?? 0))[0]
...
const currentPage = computed(() => Number(props.items?.meta?.current_page ?? 1))
        ...
        >
          <div class="grid gap-4 lg:grid-cols-12">
            <div class="lg:col-span-8">
              <label class="text-xs font-semibold text-slate-700 dark:text-slate-200" for="q">Buscar</label>
            ...
            <div class="lg:col-span-4">
              <label class="text-xs font-semibold text-slate-700 dark:text-slate-200" for="cat">Categoría</label>
              <select
                id="cat"
                v-model="categoriaId"
          ...
          <div class="mt-5 border-t border-slate-200/70 pt-5 dark:border-neutral-800/70">
            <div class="flex items-center justify-between gap-3">
              <p class="text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-300">Marcas</p>
              <button
                type="button"
                class="text-xs font-semibold text-slate-700 underline-offset-4 hover:underline dark:text-slate-200"
                @click="marcaId = ''"
              >
                Ver todas
              </button>
          ...
          <div class="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            >
              <div class="relative h-44 w-full bg-slate-100/40 dark:bg-neutral-900/40">
                ...
                <div class="absolute bottom-3 left-4 right-4 flex items-center justify-between gap-2 opacity-0 transition group-hover:opacity-100">
              ...
              <div class="p-5">
                ...
                <p v-else class="mt-2 text-sm text-slate-500 dark:text-slate-400">Sin descripción.</p>
                ...
                <div class="mt-4 flex items-end justify-between gap-3">
                  ...
                  <button
                    ...
                    class="inline-flex h-10 items-center justify-center rounded-xl bg-blue-950 px-4 text-xs font-semibold text-white
                           opacity-70 cursor-not-allowed transition group-hover:opacity-80"
